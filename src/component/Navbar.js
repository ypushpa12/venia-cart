                    ...
                    <div className="collapse navbar-collapse" id="navbarSupportedContent">
                        <ul className="navbar-nav mx-auto mb-2 mb-lg-0">
                            <li className="nav-item">
                                <a className="nav-link active" aria-current="page" to="/women's" onClick={() => filterProduct("women's")}>women</a>
                            </li>
                            <li className="nav-item">
                            ...
                            <li className="nav-item">
                                <a className="nav-link" to="/products">Accessories</a>
                            </li>
                        ...
                        <div className="buttons">
                            ...
                            <a href="" className="btn btn-grey">
                                <i className='fa fa-login'>Sign in</i>
                            </a>
